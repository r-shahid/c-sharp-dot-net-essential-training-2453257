...
// Console.WriteLine($"{AprFools:dddd, MMMM, d yyyy}"); //full everything even day of the week
// Console.WriteLine($"{AprFools:ddd h:mm:ss tt}"); //abbreviated day of the week and time
// Console.WriteLine($"{AprFools:MMM d yyyy}"); // abbreviated month, and day and year

DateTime date = new DateTime(2036, 2, 1); 
DateTime today = DateTime.Today;
TimeSpan tspan = date-today;
